    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <form method="post" action="{{ route('admin.products.store') }}" class="product-vali"
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-6">
                                            ...
                                            <input type="text" id="code" name="code" class="form-control"
                                                placeholder="Nhập mã sản phẩm" value="{{ old('code') ?? '' }}">
                                            @error('code')
                                                <div class="mt-2">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-6 mt-3">
                                            ...
                                            <input type="text" class="form-control" id="price_old" name="price_old"
                                                placeholder="Nhập giá cũ" value="{{ old('price_old') ?? '' }}">
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="title_seo"
                                                value="{{ old('title_seo') ?? '' }}" placeholder="Nhập tiêu đề SEO">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_seo" class="form-control" cols="30" rows="10">{{ old('description_seo') ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <select class="form-control" name="language_id" id="language">
                                                        ...
                                                        @if (!empty($language))
                                                            @foreach ($language as $lg)
                                                                <option value="{{ $lg->id }}"
                                                                    @selected(old('language_id') == $lg->id)>{{ $lg->name }}
                                                                </option>
                                                            @endforeach
                                                        @endif
                                                    </select>
