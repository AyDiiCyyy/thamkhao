                            ...
                            <div class="email-left-box border-end  dlab-scroll" id="email-left">
                                <div class="p-0">
                                    <a href="{{ route('admin.pages.create') }}" class="btn btn-dark btn-block"><i
                                            class="fa-solid fa-plus me-2"></i>Thêm mới trang</a>
                                </div>
                                <div class="mail-list rounded ">
                                    <a href="javascript:void(0);" class="list-group-item active"><i
                                            class="fa-regular fa-file align-middle"></i>Trang</a>
                                </div>
...
{{--                                    <a href="{{ route('admin.blocks.create') }}" class="list-group-item change">Tạo khối cho trang</a>--}}
{{--                                </div>--}}
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="file-header">
                                <div class="card-body py-0">
                                    <div class="page-titles">
                                        <div class="my-2">
                                            <h2 class="card-title">Danh sách trang</h2>
                                            <div class="file-path">
                                                <div class="me-2">
                                                ...
                                                <h4>
                                                    <a>Giao diện /</a><a href="{{ route('admin.pages.index') }}">Trang /</a><a href="{{ route('admin.pages.index') }}">Danh sách</a>
                                                </h4>
                                        ...
                                        <div class="d-flex my-2 file-left-body">
                                            <div class="input-group me-3">
                                                <span class="input-group-text solid pe-0"><a
                                                        href="javascript:void(0)"><svg width="28" height="28"
                                                                                       viewBox="0 0 28 28"
                                                                                       fill="none"
                                                                                       xmlns="http://www.w3.org/2000/svg">
                                                    <path opacity="0.3"
                                            ...
                                            <div class="file-list">
                                                ...
                                                <div class="dz-info">
                                                    ...
                                                    <div class="mt-1 d-flex justify-content-center align-items-center">
                                                        <a href="{{ route('admin.pages.edit', $page->id) }}" class="text-hover">Sửa nhanh</a>
                                                        <form action="{{ route('admin.pages.delete', $page->id) }}" class="formDelete" method="post">
                                                            @csrf
                                                            @method('DELETE')
