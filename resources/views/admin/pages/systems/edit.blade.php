    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12">
                            ...
                            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ $title['edit'] ?? 'Cập nhật cho hệ thống' }}
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <form method="post" action="{{ route('admin.systems.update', $system->id) }}{{ request()->system_id > 0 ? '?system_id=' . request()->system_id : '' }}" class="product-vali"
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-6">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control"
                                                   placeholder="Nhập tên nội dung" value="{{ old('name') ?? $system->name }}">
                                            @error('name')
                                            <div class="mt-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" id="slug" name="slug"
                                                   placeholder="Nhập đường dẫn" value="{{ old('slug') ?? $system->slug }}">
                                            @error('slug')
                                            <div class="mt-2">
                                                <span class="text-red">{{ $message }}</span>
                                            </div>
                        ...
                        <div class="col-xl-4">
                            <div class="right-sidebar-sticky">
                                        ...
                                        <div class="row">
                                                    ...
                                                    <select class="form-control" name="language_id" id="language">
                                                        ...
                                                        @if(!empty($languages))
                                                            @foreach($languages as $language)
                                                                <option {{ $system->language_id == $language->id ? 'selected' : '' }} value="{{ $language->id }}">{{ $language->name }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                    @error('language_id')
                                            ...
                                            <div class="col-6">
                                                <div class="p-3">
                                                    ...
                                                    <input class="form-control" value="{{ $system->order ?? 0 }}" type="number" min="0" id="order"
                                                           name="order">
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <input class="form-check-input" type="radio" id="active"
                                                                   name="active" value="1" {{ $system->active == 1 ? 'checked' : '' }}>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input class="form-check-input" value="0" type="radio" id="active"
                                                                   name="active" {{ $system->active == 0 ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="active">
                                                                Ẩn
                                                            </label>
                                                        </div>
                                ...
                                <div class="mt-3 d-flex justify-content-start gap-2">
                                    ...
                                    <a href="{{ route('admin.systems.index', request()->system_id > 0 ? 'system_id=' . request()->system_id : '') }}" class="btn btn-warning">Trở về
                                        trang
                                        danh
                                        sách
                                    </a>
