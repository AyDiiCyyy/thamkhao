                        ...
                        <div class="email-left-body">
                            <div class="email-left-box border-end  dlab-scroll" id="email-left">
                                <div class="p-0">
                                    <button data-bs-toggle="modal"
                                       data-bs-target="#modalAddBlock" class="btn btn-dark btn-block"><i
                                            class="fa-solid fa-plus me-2"></i>Thêm mới khối</button>
                                </div>
                                <div class="mail-list rounded ">
                                    <a href="javascript:void(0);" class="list-group-item active"><i
                                            class="fa-regular fa-file align-middle"></i>Khối</a>
                                </div>
                                ...
                                <div class="mail-list rounded overflow-hidden mt-2">
                                    <a href="{{ route('admin.blockTypes.index') }}" class="list-group-item change">Danh sách loại khối</a>
                                    <a href="{{ route('admin.blockTypes.create') }}" class="list-group-item change">Thêm loại khối</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="row gx-0">
                                        ...
                                        <div class="col-xl-3 col-sm-6">
                                            <div class="drive">
                                                <div class="dz-folder">
                                                    <svg width="60" height="62" viewBox="0 0 79 62" fill="none"
                                                ...
                                                <div class="drive-content">
                                                    ...
                                                    <div class="progress default-progress">
                                                        <div class="progress-bar bg-vigit progress-animated bg-primary"
                                                             style="width: 60%; height:100%;" role="progressbar">
                                                            <span class="sr-only">60% Complete</span>
                                                        </div>
                                                    </div>
                                                    <small>40 GB / 50GB</small>
                                                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="file-header">
                                <div class="card-body py-0">
                                    <div class="page-titles">
                                        <div class="my-2">
                                            <h2 class="card-title">Danh sách khối trang</h2>
                                            <div class="file-path">
                                                <div class="me-2">
                                                ...
                                                <h4>
                                                    <a>Giao diện /</a><a href="{{ route('admin.blocks.index') }}">Khối trang /</a><a href="{{ route('admin.blocks.index') }}">Danh sách khối trang</a>
                                                </h4>

                                            </div>

                                        </div>
                                        <div class="d-flex my-2 file-left-body">
                                            <div class="input-group me-3">
                                                <span class="input-group-text solid pe-0">
                                                ...
                                                <input type="text" class="form-control solid border-start-0 ps-2"
                                            ...
                                            <div class="d-flex align-items-center folder-layout-tab">
                                                ...
                                                <div class="email-tools-box ms-auto">
                                ...
                                @if(!empty($blocks))
                                    @foreach($blocks as $key => $block)
                                        <li>
                                            <div class="file-list">
                                                <div class="dz-media">
                                                    <svg xmlns="http://www.w3.org/2000/svg" stroke="#1B87FF" fill="#1B87FF"  viewBox="0 0 512 512">
                                                ...
                                                <div class="dz-info">
                                                    ...
                                                    <div class="mt-1 d-flex justify-content-center align-items-center">
                                                        <a href="{{ route('admin.blocks.edit', $block->id) }}" class="text-hover">Sửa nhanh</a>
                                                        <form action="{{ route('admin.blocks.delete', $block->id) }}" class="formDelete" method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="text-hover bt-form btnDelete">Xóa</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
