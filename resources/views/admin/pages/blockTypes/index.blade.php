                    ...
                    <div class="file-left-body">
                        <div class="email-left-body">
                            <div class="email-left-box border-end  dlab-scroll" id="email-left">
                                <div class="p-0">
                                    <a href="{{ route('admin.blocks.create') }}" class="btn btn-dark btn-block"><i
                                            class="fa-solid fa-plus me-2"></i>Thêm mới khối</a>
                                </div>
                                <div class="mail-list rounded">
                                    <a href="{{ route('admin.blocks.index') }}" class="list-group-item"><i
                                ...
                                <div class="mail-list rounded overflow-hidden mt-2">
                                    <a href="{{ route('admin.blockTypes.index') }}"
                                       class="list-group-item change active">Danh sách loại khối</a>
                                    <a href="{{ route('admin.blockTypes.create') }}" class="list-group-item change">Thêm
                                        loại khối</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="page-titles">
                                        <div class="my-2">
                                            ...
                                            <div class="file-path">
                                                ...
                                                <h4>
                                                    <a>Giao diện /</a><a href="{{ route('admin.blocks.index') }}">Khối
                                                        trang /</a><a href="{{ route('admin.blockTypes.index') }}">Loại
                                                        khối /</a><a href="{{ route('admin.blockTypes.index') }}">Danh
                                                        sách loại khối</a>
                                                </h4>
