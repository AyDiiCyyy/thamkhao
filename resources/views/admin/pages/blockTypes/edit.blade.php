                    ...
                    <div class="col-xl-8">
                        <div class="card h-auto">
                            <div class="card-body">
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <label class="form-label mb-2">Tên loại khối</label>
                                        <input type="text" id="name" name="name" class="form-control"
                                               placeholder="Nhập tên loại khối" value="{{ old('name') ?? $blockType->name }}">
                                        @error('name')
                                        <div class="mt-2">
                    ...
                    <div class="col-xl-4">
                        <div class="right-sidebar-sticky">
                                    ...
                                    <div class="row">
                                                ...
                                                <select class="form-control" name="language_id" id="language">
                                                    ...
                                                    @if(!empty($languages))
                                                        @foreach($languages as $language)
                                                            <option {{ $blockType->language_id == $language->id ? 'selected' : '' }}
                                        ...
                                        <div class="col-6">
                                            <div class="p-3">
                                                ...
                                                <input class="form-control" value="{{ $blockType->order ?? 0 }}" type="number" min="0" id="order"
                                                       name="order">
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <input class="form-check-input" type="radio" id="active"
                                                               name="active" value="1" {{ $blockType->active == 1 ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-check-input" value="0" type="radio" id="active"
                                                               name="active" {{ $blockType->active == 0 ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="active">
                                                            Ẩn
                                                        </label>
                                                    </div>
                            ...
                            <div class="mt-3 d-flex justify-content-start gap-2">
                                ...
                                <a href="{{ route('admin.blockTypes.index') }}" class="btn btn-warning">Trở về
                                    trang
                                    danh
                                    sách
                                </a>
